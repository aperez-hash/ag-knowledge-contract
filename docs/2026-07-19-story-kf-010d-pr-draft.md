...
- Primary-source dossier for `IRNR - Establecimientos Permanentes`.
- Canonical Knowledge Object: `examples/irnr-establecimientos-permanentes.json`.
- Story helper: `scripts/lib/knowledge-object-story-kf-010d.mjs`.
- Artifact builder and validator entrypoints for `STORY-KF-010D`.
